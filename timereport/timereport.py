...
def post_ephemeral(attachment, channel_id, user_id):
...
def post_message(channel_id, user_id, user_name, type_id, hours, date_start, date_end, attachment=None):
    ...
    slack_client.api_call("chat.postMessage", channel=channel_id, user=user_id, attachments=attachment)
...
def timereport():
    ...
    user_name_regex = "(?:{typid}).(?:{start}).(?:{end})?.(?:{hours})?(.*)".format(typid=type_id,
                                                                                   start=date_start,
                                                                                   end=date_end,
                                                                                   hours=hours)
    ...
    # post
    post_message(channel_id, user_id, user_name, type_id, hours, date_start, date_end)
